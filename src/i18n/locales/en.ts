export const en = {
  ...
  "admin.section.attributes.body": "The shared attribute library: definitions, their categories, and what a listing card shows.",
  ...
  "admin.attributes.type.select": "Single choice",
  ...
  "admin.attributes.delete.hint": "The definition disappears from the library. Categories that use it must be unlinked first.",
  ...
  "admin.attributes.merge.hint": "Every link on the chosen duplicates moves to the surviving attribute; the duplicates are then removed.",
  ...
  "admin.attributes.merge.result": "{moved} links moved · {folded} folded into an existing link · {removed} definitions removed.",
  ...
  "admin.attributes.error.inUse": "{count} categories still use this attribute. Unlink it everywhere first.",
  ...
  "admin.attributes.error.mergeTargetInSources": "The surviving attribute cannot also be a duplicate.",
  ...
  "admin.categories.tip.needsCard": "An active category that accepts listings needs at least two attributes shown on its listing cards.",
