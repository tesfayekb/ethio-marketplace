export const en = {
  ...
  "admin.locations.tip.active": "Visible in browse while every ancestor is active.",
  "admin.locations.tip.retired":
    "Kept with its history, but hidden from browse together with everything under it.",
  ...
  "admin.countries.tip.open": "Shoppers can browse this market and sellers can post in it.",
  "admin.countries.tip.closed":
    "Prepared but hidden: places can be curated before the market opens.",
  ...
  "admin.countries.create.open": "Add a country",
  "admin.countries.create.title": "Add a country",
  "admin.countries.create.code": "Two-letter code",
  "admin.countries.create.codeHint": "The ISO 3166-1 alpha-2 code, e.g. ET.",
  "admin.countries.create.bornClosed": "Created closed \u2014 open it when its places are ready.",
