export const en = {
  ...
  "post.pin.noResults": "No place found by that name.",
  "post.pin.locate": "Use my location",
  "post.pin.locating": "Finding your location…",
  "post.pin.locateRefused": "Your browser did not share your location. You can still tap the map.",
  "post.pin.locateUnavailable": "This device cannot share a location. Tap the map instead.",
  "post.pin.layerStreet": "Streets",
  "post.pin.layerSatellite": "Satellite",
  "post.pin.tapHint": "Tap the map, or drag the pin, to place it.",
  "post.pin.streetLabel": "Street or landmark",
  "post.pin.streetHint": "Filled in from the map — change it to whatever a buyer would recognise.",
  "post.pin.precisionLabel": "What buyers see",
  "post.pin.precisionExact": "Show exact pin",
  "post.pin.precisionApprox": "Show approximate area (500 m)",
  "post.pin.save": "Save the pin",
  ...
  "post.specs.lockedByChoice": "Set by your choice",
  ...
  "post.preview.detailsLabel": "Details",
  "post.preview.descriptionLabel": "Description",
  "post.preview.sellerLabel": "Seller",
  "post.preview.mapPlaceholder": "The map of this place opens with the listing.",
  "post.preview.photoCount": "Photo {index} of {total}",
  "admin.attributes.link.allowedOptions": "Allowed options",
  "admin.attributes.link.allowedOptionsHint":
