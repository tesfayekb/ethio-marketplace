...
Current position: CURATION ERA CLOSED 2026-09-15 — fifteen roots in a popularity-weighted rail, 142 listing categories, 327 definitions, zero retired rows, the library sweep imported, four-lens review recorded (docs/governance/reviews/curation-era-closeout-2026-09-15.md); DEC-050, DEC-057/057b LANDED IN FULL; DEC-054/059 proven; DEC-049b, DEC-060, DEC-061 RATIFIED; DEC-056/058 RATIFIED (build at/after U7); INC-174/185/187–200 CLOSED; Knowledge v3.8 and instructions v1.10 installed. LOCATIONS ERA OPEN 2026-09-15 — spec ratified at S37 (docs/governance/locations-era-spec.md; DEC-033 executing; DEC-062/063/064/065/066 ratified; DEC-055 first landing at L1a); L1 COMPLETE 2026-09-15; L2 COMPLETE 2026-09-16 (Places · Countries · Coverage consoles under a clickable Locations overview; every ISO 3166-1 country seeded, ET and US open); L4 COMPLETE 2026-09-16 (geo guess: DEC-063 verdict cf-header, amended with the visitor-location source; the shell picker on the cached tree; the saved-area cookie); INC-201/202/204–207 CLOSED, INC-203 OPEN. Open: INC-186, INC-203, ACT-C3-1, C3-UX-3/4/10, C4 tags disposition, the U7 rail flyout, the assets badge; amendment proposals pending the operator (instructions v1.11, Knowledge v3.9). NEXT: L3 — the curator's files (locations-et, locations-diaspora) imported through Places → Import, Amharic approved in Translations → Data → era gate (four-lens review; name_am totality) → posting-prerequisites census → U6 Posting. Launch gate gains the ethio.com cutover item (see docs/governance/launch-gate.md).
