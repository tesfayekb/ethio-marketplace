...
Current position: CURATION ERA CLOSED 2026-09-15 — fifteen roots in a popularity-weighted rail, 142 listing categories, 327 definitions, zero retired rows, the library sweep imported, four-lens review recorded (docs/governance/reviews/curation-era-closeout-2026-09-15.md); DEC-050, DEC-057/057b LANDED IN FULL; DEC-054/059 proven; DEC-049b, DEC-060, DEC-061 RATIFIED; DEC-056/058 RATIFIED (build at/after U7); INC-174/185/187–200 CLOSED; Knowledge v3.8 and instructions v1.10 installed. LOCATIONS ERA OPEN 2026-09-15 — spec ratified at S37 (docs/governance/locations-era-spec.md; DEC-033 executing; DEC-062/063/064/065 ratified; DEC-055 first landing at L1a); L1 COMPLETE 2026-09-15 (L1a schema, ancestry triggers, permissions, ten admin doors · L1b import family in the database and at the gate · L1c public per-country tree read and the ETag'd route); INC-201/202 CLOSED, INC-203 OPEN. Open: INC-186, INC-203, ACT-C3-1, C3-UX-3/4/10, C4 tags disposition, the U7 rail flyout, the assets badge. NEXT: L2 (console: Tree · Countries · Coverage · Import/Export tabs, LT E2E, DEC-062 reaper delta) → L3 (curator files) → L4a → L4b → era gate → posting-prerequisites census → U6 Posting.
