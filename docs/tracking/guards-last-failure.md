...
- Attempt: 2
- Written (UTC): 2026-09-22T02:38:48.724Z
 ...
 * branch            dev        -> FETCH_HEAD
   13c7630..4981078  dev        -> origin/dev
HEAD is now at 4981078 ci: update CI status report [skip ci]
Flake ledger: appended 1 line(s) to docs/tracking/flake-ledger.md.
[dev b3ba869] ci: e2e failure report + flake ledger [skip ci]
 2 files changed, 73 insertions(+), 103 deletions(-)
To https://github.com/tesfayekb/ethio-marketplace
   4981078..b3ba869  HEAD -> dev
...
git version 2.55.0
Temporarily overriding HOME='/home/runner/work/_temp/98468798-bb2a-4da7-add9-c134cbb87649' before making global git config changes
