...
- Attempt: 2
- Written (UTC): 2026-09-16T22:16:36.581Z
 ...
 * branch            dev        -> FETCH_HEAD
   073f1a8..8fe3ba9  dev        -> origin/dev
HEAD is now at 8fe3ba9 ci: update CI status report [skip ci]
Flake ledger: appended 1 line(s) to docs/tracking/flake-ledger.md.
[dev 1177721] ci: e2e failure report + flake ledger [skip ci]
 2 files changed, 56 insertions(+), 101 deletions(-)
To https://github.com/tesfayekb/ethio-marketplace
   8fe3ba9..1177721  HEAD -> dev
...
git version 2.55.0
Temporarily overriding HOME='/home/runner/work/_temp/e6e91279-c479-436b-8bb3-c5dca5d892f5' before making global git config changes
