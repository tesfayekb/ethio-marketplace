...
- Attempt: 1
- Written (UTC): 2026-09-23T11:04:18.232Z
...
git version 2.55.0
Temporarily overriding HOME='/home/runner/work/_temp/b2030b44-f2e2-4252-a675-b9fdeb36e880' before making global git config changes
...
env:
  ...
  E2E_GREEN: 0
  E2E_RUN_URL: https://github.com/tesfayekb/ethio-marketplace/actions/runs/35850846689
  E2E_HEAD_COMMIT_MESSAGE: Reran CI shards, found 1 real failure

X-Lovable-Edit-ID: edt-9872e241-28a4-434a-a278-6bfc35840489
...
Flake ledger: appended 6 line(s) to docs/tracking/flake-ledger.md.
Flake ledger: appended 6 line(s) to docs/tracking/flake-ledger.md.
From https://github.com/tesfayekb/ethio-marketplace
 * branch            dev        -> FETCH_HEAD
HEAD is now at 58fec4e Reran CI shards, found 1 real failure
Flake ledger: appended 6 line(s) to docs/tracking/flake-ledger.md.
[dev 74b3ccc] ci: e2e failure report + flake ledger [skip ci]
 2 files changed, 102 insertions(+), 171 deletions(-)
To https://github.com/tesfayekb/ethio-marketplace
   58fec4e..74b3ccc  HEAD -> dev
...
[command]/usr/bin/git version
git version 2.55.0
Temporarily overriding HOME='/home/runner/work/_temp/2aeae75b-12f3-438a-9448-437d7540077e' before making global git config changes
Adding repository directory to the temporary git global config as a safe directory
[command]/usr/bin/git config --global --add safe.directory /home/runner/work/ethio-marketplace/ethio-marketplace
[command]/usr/bin/git config --local --name-only --get-regexp core\.sshCommand
[command]/usr/bin/git submodule foreach --recursive sh -c "git config --local --name-only --get-regexp 'core\.sshCommand' && git config --local --unset-all 'core.sshCommand' || :"
