...
- Attempt: 1
- Written (UTC): 2026-09-17T17:39:28.748Z
...
```text
+    "post.specs.multiHint": [
+      "/post",
+      "/post/$listingId"
+    ],
+    "post.specs.needCategory": [
+      "/post",
+      "/post/$listingId"
+    ],
+    "post.specs.noBound": [
...
+      "/post/$listingId"
+    ],
+    "post.specs.otherPlaceholder": [
+      "/post",
+      "/post/$listingId"
+    ],
+    "post.specs.presetHint": [
+      "/post",
+      "/post/$listingId"
+    ],
+    "post.specs.unitHint": [
...
git version 2.55.0
Temporarily overriding HOME='/home/runner/work/_temp/6483641a-a1f3-4326-b62a-29f4eee110cd' before making global git config changes
...
Checking formatting...
[[33mwarn[39m] src/features/posting/posting-service.ts
[[33mwarn[39m] src/features/posting/step-specifications.tsx
[[33mwarn[39m] src/i18n/locales/en.ts
...
[command]/usr/bin/git version
git version 2.55.0
Temporarily overriding HOME='/home/runner/work/_temp/93d72bd2-4a7d-47fb-95d1-68ed67ee5f6b' before making global git config changes
Adding repository directory to the temporary git global config as a safe directory
[command]/usr/bin/git config --global --add safe.directory /home/runner/work/ethio-marketplace/ethio-marketplace
[command]/usr/bin/git config --local --name-only --get-regexp core\.sshCommand
[command]/usr/bin/git submodule foreach --recursive sh -c "git config --local --name-only --get-regexp 'core\.sshCommand' && git config --local --unset-all 'core.sshCommand' || :"
...
env:
  ...
  E2E_GREEN: 0
  E2E_RUN_URL: https://github.com/tesfayekb/ethio-marketplace/actions/runs/35252497677
  E2E_HEAD_COMMIT_MESSAGE: Added Amharic market names

X-Lovable-Edit-ID: edt-95bc6e97-6588-439a-ac61-e7600481bb96
...
Flake ledger: appended 4 line(s) to docs/tracking/flake-ledger.md.
Flake ledger: appended 4 line(s) to docs/tracking/flake-ledger.md.
From https://github.com/tesfayekb/ethio-marketplace
 * branch            dev        -> FETCH_HEAD
HEAD is now at 09768b2 Added Amharic market names
Flake ledger: appended 4 line(s) to docs/tracking/flake-ledger.md.
[dev b1526aa] ci: e2e failure report + flake ledger [skip ci]
 2 files changed, 112 insertions(+), 6 deletions(-)
To https://github.com/tesfayekb/ethio-marketplace
   09768b2..b1526aa  HEAD -> dev
...
[command]/usr/bin/git version
git version 2.55.0
Temporarily overriding HOME='/home/runner/work/_temp/cf95dadd-bbe7-472f-98a1-364a6ed3816b' before making global git config changes
Adding repository directory to the temporary git global config as a safe directory
[command]/usr/bin/git config --global --add safe.directory /home/runner/work/ethio-marketplace/ethio-marketplace
[command]/usr/bin/git config --local --name-only --get-regexp core\.sshCommand
[command]/usr/bin/git submodule foreach --recursive sh -c "git config --local --name-only --get-regexp 'core\.sshCommand' && git config --local --unset-all 'core.sshCommand' || :"
