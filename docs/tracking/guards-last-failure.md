...
- Run: https://github.com/tesfayekb/ethio-marketplace/actions/runs/35431333568  **PLATFORM-ORIGIN?**
- Commit: `c1487d090e8d5221903daf10fb1d8b78ab3b35bc`
- Attempt: 1
- Written (UTC): 2026-09-19T08:25:30.317Z
...
env:
  ...
  E2E_GREEN: 0
  E2E_RUN_URL: https://github.com/tesfayekb/ethio-marketplace/actions/runs/35431333568
...
HEAD is now at c1487d0 Work in progress
Flake ledger: appended 4 line(s) to docs/tracking/flake-ledger.md.
[dev c4b4767] ci: e2e failure report + flake ledger [skip ci]
 2 files changed, 68 insertions(+), 111 deletions(-)
To https://github.com/tesfayekb/ethio-marketplace
   c1487d0..c4b4767  HEAD -> dev
...
git version 2.55.0
Temporarily overriding HOME='/home/runner/work/_temp/42502ff2-29d5-4976-be88-078b574ea636' before making global git config changes
